...
table:
  ...
  - dimension: Connectors
    ...
    us: 46 planned for first release, none shipping yet
...
working is a real thing to buy, and our 46 planned connectors are not a
counter-argument — they are a smaller number that does not exist yet.
