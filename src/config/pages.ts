...
export const PAGES: PageMeta[] = [
  ...
  },
  {
    ...
    summary:
      'Connector catalogue: 50 connectors across 6 categories (databases, warehouses and lakehouses, files and formats, object storage, streaming, SaaS and APIs), filterable by search and category. 16 are marked working (built in the engine and tested against real data, not yet released) and 34 planned. States plainly that none is released, because the product is pre-launch.',
    group: 'Product',
  },
  {
    path: '/security',
